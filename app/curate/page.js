          ...
          <div className="bg-white rounded-lg p-6 mb-6">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 text-sm mb-3">
                Reviewing your existing knowledge database, here are four options for handling this
                information:
              </p>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-gray-600 text-sm mb-3">{rec.change}</div>
                        ...
                        <div className="text-xs text-gray-500 mb-3 bg-white p-2 rounded border">
                          ...
                          {rec.preview ||
                            (rec.updated_text
                              ? rec.updated_text.substring(0, 100) + '...'
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-gray-600 text-sm mb-3">
                        Discard this input and return to the main interface. This information will
                        not be saved to your knowledge database.
                      </div>
                      ...
                      <div className="text-xs text-gray-500 mb-3 bg-white p-2 rounded border">
                        <strong>Action:</strong> Clear current input and return to main interface
            ...
            <div>
              ...
              <p className="text-gray-700 text-sm">
                Based on your knowledge database, I recommend choosing the option that best fits
                your current learning goals and organizational structure.
              </p>
            </div>
          </div>
        )}
