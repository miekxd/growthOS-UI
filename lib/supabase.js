    ...
    if (existingItems && existingItems.length > 0) {
      ...
      return {
        ...
        tags: Array.isArray(updatedItem.tags) 
          ? updatedItem.tags 
          : (typeof updatedItem.tags === 'string' ? JSON.parse(updatedItem.tags) : (updatedItem.tags || []))
      };
      ...
      return {
        ...
        tags: Array.isArray(createdItem.tags) 
          ? createdItem.tags 
          : (typeof createdItem.tags === 'string' ? JSON.parse(createdItem.tags) : (createdItem.tags || []))
      };
    }
  },
